    ...
    async def ingest(
        ...
        *,
        ...
        if entity_type == EntityType.GENERIC:
            dataset.raw_content = content
            dataset.status = DatasetStatus.INGESTED
            dataset.rows_accepted = dataset.rows_total
            dataset.rows_rejected = 0
            ...
            logger.info("ingest_generic_complete", extra={"rows": dataset.rows_accepted})
